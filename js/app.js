(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-tickets__wrapper-btn_prev",
                nextEl: ".slider-tickets__wrapper-btn_next"
            },
            breakpoints: {
                640: {
                    slidesPerView: 1,
    ...
    let volumeControl = document.querySelector(".player__volume");
    let seekBg = document.querySelector(".player__seek-backround");
    playPauseButton.addEventListener("click", (function() {
        if (audio.paused) {
            audio.play();
            document.querySelector(".player__play-icon").style.display = "none";
            document.querySelector(".player__pause-icon").style.display = "inline";
        } else {
            audio.pause();
            document.querySelector(".player__play-icon").style.display = "inline";
            document.querySelector(".player__pause-icon").style.display = "none";
        }
    }));
    ...
    audio.addEventListener("ended", (function() {
        audio.currentTime = 0;
        document.querySelector(".player__time").textContent = "00:00 - 00:00";
        document.querySelector(".player__play-icon").style.display = "inline";
        document.querySelector(".player__pause-icon").style.display = "none";
    }));
    audio.addEventListener("timeupdate", (function() {
        ...
        seekBg.style.width = position * 100 + "%";
        ...
        let totalMinValue;
        let totalSecValue;
        if (totalMin < 10) totalMinValue = "0" + totalMin; else totalMinValue = totalMin;
        if (totalSec < 10) totalSecValue = "0" + totalSec; else totalSecValue = totalSec;
        let totalTime = totalMinValue + ":" + totalSecValue;
        timeDisplay.textContent = audioTime + " - " + totalTime;
    }));
